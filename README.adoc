= start.spring.io with Gitpod
:library: https://github.com/spring-io/initializr

This is a fork of start.spring.io that adds a button to start an online workspace in Gitpod.

You can try it out by starting workspace on this repository and then play with the app started on port 8080.

image:https://gitpod.io/button/open-in-gitpod.svg[link="https://gitpod.io/from-referrer/"]
